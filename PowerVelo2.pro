...
win32 {
    ...
    LIBS        += -LF:/Workspaces/Qt/vlc-qt/binary/lib
    INCLUDEPATH += F:/Workspaces/Qt/vlc-qt/binary/include
    ...
    #--------- ANT_LIB
    INCLUDEPATH += F:\Workspaces\Qt\ANT-SDK_PC.3.5\ANT_LIB\inc
    INCLUDEPATH += F:\Workspaces\Qt\ANT-SDK_PC.3.5\ANT_LIB\common
    INCLUDEPATH += F:\Workspaces\Qt\ANT-SDK_PC.3.5\ANT_LIB\libraries
    INCLUDEPATH += F:\Workspaces\Qt\ANT-SDK_PC.3.5\ANT_LIB\software\ANTFS
    INCLUDEPATH += F:\Workspaces\Qt\ANT-SDK_PC.3.5\ANT_LIB\software\serial
    INCLUDEPATH += F:\Workspaces\Qt\ANT-SDK_PC.3.5\ANT_LIB\software\serial\device_management
    INCLUDEPATH += F:\Workspaces\Qt\ANT-SDK_PC.3.5\ANT_LIB\software\system
    INCLUDEPATH += F:\Workspaces\Qt\ANT-SDK_PC.3.5\ANT_LIB\software\USB
