...
//    postData.addQueryItem("FTP", QString::number(account->getFTP()) );
//    postData.addQueryItem("LTHR", QString::number(account->getLTHR()) );
//    postData.addQueryItem("minutes_rode", QString::number(account->minutes_rode) );
//    postData.addQueryItem("weight_kg", QString::number(account->getWeightKg()) );
